function FechaDeLlegada(props) {
  return (
    <div>
      <h4 className="nombreFiltro">Check-in:</h4>
      <input
        type="date"
        className="filters"
        value={props.llegada}
        onChange={props.ManejarCambioLlegada}
      />
    </div>
  );
}
export default FechaDeLlegada;
// import { useState } from "react";

// function FechaDeLlegada() {
